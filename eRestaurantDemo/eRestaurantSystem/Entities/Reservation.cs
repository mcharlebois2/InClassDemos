...
namespace eRestaurantSystem.Entities
{
    public class Reservation
    {
        ...
        [Range(1,16, ErrorMessage="Party size is limited to a max of 16.")]
        ...
        //however ReservationTables holds ONLY a compound primary key
        //we will not create a reservations table entity in our project
        //but handle it via navigation mapping
        //Therefore we will place a ICollection property in this entity refering to the tables table.
